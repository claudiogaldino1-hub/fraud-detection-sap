# Documentação Técnica v1.3 — SAP P2P Fraud Detection System

> **Versão:** 1.3 | **Pipeline:** `de9b92f4` | **Commit:** atual
...
- **Documentação — Cenários de Fraude:** tabela de cenários corrigida (6 códigos divergiam do `FraudInjector`; `SOD_PO_AND_RECEIPT` estava ausente) e novo Capítulo 9 adicionado com mapeamento completo de cada cenário a tabela SAP e camada de detecção.
